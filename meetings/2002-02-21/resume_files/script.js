...
var gDocTable = new Array(
   ...
   new hrefList("slide0112.htm", 1, 4),
   new hrefList("slide0113.htm", 1, 5),
   new hrefList("slide0114.htm", 1, 6),
   new hrefList("slide0115.htm", 1, 7),
   new hrefList("slide0116.htm", 1, 8),
   new hrefList("slide0117.htm", 1, 9),
   new hrefList("slide0118.htm", 1, 10),
   new hrefList("slide0119.htm", 1, 11)
);
